...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		HomesteadBlock: big.NewInt(0), // homestead block right from start
		DAOForkBlock:   nil, // no need
		DAOForkSupport: true,
		EIP150Block:    big.NewInt(0),
		EIP150Hash:     common.HexToHash("0x2086799aeebeae135c246c65021c82b4e15a2c451340993aacfd2751886514f0"),
		EIP155Block:    big.NewInt(10), // right from start
		EIP158Block:    big.NewInt(10), // right from start
